...
@section('content')
    ...
    <body class="bg-white font-[Poppins] transition-all duration-150 dark:bg-[#08080a]">
        ...
        <section id="Category-result" class="mx-auto mt-[70px] max-sm:mt-[50px] flex max-w-[1130px] flex-col items-center gap-[30px] max-sm:gap-[20px] max-sm:mx-5">
            <h1 class="text-center text-4xl max-sm:text-3xl font-bold leading-[45px] dark:text-white">
                Explore Our <br />
                {{ $category->name }} News
            </h1>
