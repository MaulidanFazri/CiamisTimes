...
@section('content')
    ...
    <body class="font-[Poppins] dark:bg-[#08080a]">
        ...
        <!-- Heading -->
        <section id="heading"
            class="mx-auto mt-[70px] flex max-w-[1130px] flex-col items-center gap-[30px] max-sm:mt-[50px] max-sm:gap-[20px]">
            <h1 class="text-center text-4xl font-bold leading-[45px] dark:text-white max-sm:mx-5 max-sm:text-3xl">
