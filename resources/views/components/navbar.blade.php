    ...
    <nav id="Navbar"
        ...
        <div class="logo-container flex items-center gap-[30px] max-sm:gap-[20px]">
            <a href="{{ route('front.index') }}" class="flex shrink-0">
                <img src="{{ asset('assets/images/logos/logo.svg') }}" alt="logo" id="logo"
                    class="w-[125px] transition-colors duration-100 max-sm:h-[36px] max-sm:w-auto" />
            </a>
            ...
            <form method="GET" action="{{ route('front.search') }}" method="GET"
                class="flex w-[450px] grow items-center gap-[10px] rounded-full border border-[#E8EBF4] p-[12px_20px] transition-all duration-100 focus-within:ring-2 focus-within:ring-[#A72185] dark:border-zinc-600 max-[800px]:hidden">
                @csrf
        ...
        <div class="logo-container flex flex-shrink-0 items-center gap-[30px] max-sm:gap-[20px]">
            ...
            <button id="darkModeToggle"
                class="group flex h-12 w-12 gap-[10px] rounded-full p-2 font-semibold ring-1 ring-[#E8EBF4] transition-all duration-100 hover:ring-2 hover:ring-[#A72185] dark:ring-zinc-600 dark:hover:ring-[#A72185] max-sm:h-[36px] max-sm:w-[36px]">

                <!-- Icon for light mode -->
                <svg class="block fill-zinc-400 transition-colors duration-100 group-hover:fill-[#A72185] dark:hidden"
                    fill="currentColor" viewBox="0 0 20 20">
                    <path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path>
                </svg>

                <!-- Icon for dark mode -->
                <svg class="hidden fill-zinc-400 transition-colors duration-100 group-hover:fill-[#A72185] dark:block"
                    fill="currentColor" viewBox="0 0 20 20">
                    <path
            ...
            <a href="mailto:ciamistimes@gmail.com?subject=Pemesanan%20Pemasangan%20Iklan%20di%20Ciamis%20Times&body=Kepada%20Tim%20Ciamis%20Times%2C%0A%0ASaya%20ingin%20melakukan%20pemesanan%20untuk%20pemasangan%20iklan%20di%20situs%20web%20Ciamis%20Times.%20Berikut%20adalah%20informasi%20terkait%20pemesanan%20iklan%3A%0A%0A-%20Nama%20Perusahaan%3A%20%5BNama%20Perusahaan%5D%0A-%20Jenis%20Iklan%3A%20%5BBanner%2C%20Square%5D%0A-%20Durasi%20Pemasangan%20Iklan%3A%20%5BBerapa%20Lama%20Iklan%20Akan%20Tayang%5D%0A-%20Anggaran%3A%20%5BAnggaran%20untuk%20Iklan%5D%0A-%20Kontak%20Person%3A%20%5BNama%20Kontak%20Person%5D%0A-%20Email%20Kontak%20Person%3A%20%5BEmail%20Kontak%20Person%5D%0A-%20Telepon%20Kontak%20Person%3A%20%5BNomor%20Telepon%20Kontak%20Person%5D%0A%0AMohon%20informasi%20lebih%20lanjut%20mengenai%20prosedur%20dan%20harga%20pemasangan%20iklan%20di%20Ciamis%20Times%2C%20serta%20syarat%20dan%20ketentuan%20yang%20berlaku.%0A%0ATerima%20kasih%20atas%20perhatian%20dan%20kerjasamanya.%20Saya%20menunggu%20balasan%20dari%20Tim%20Ciamis%20Times.%0A%0AHormat%20saya%2C%0A%5BNama%20Anda%5D%0A%5BPerusahaan%20Anda%20(jika%20ada)%5D"
                class="flex flex-shrink-0 gap-[10px] rounded-full bg-[#A72185] p-[12px_22px] font-bold text-white transition-all duration-100 hover:shadow-[0_10px_20px_0_#A7218580] dark:bg-transparent dark:ring-2 dark:ring-[#A72185] dark:hover:bg-[#A72185] dark:hover:shadow-[0_10px_20px_0_#A7218580] dark:hover:ring-0 max-[800px]:hidden max-sm:gap-2 max-sm:p-[8px_17px]">
            ...
            <button id="toggle-navbar"
                ...
                <svg id="icon-hamburger"
                    class="w-[26px] text-black transition-transform duration-300 ease-in-out group-hover:text-[#A72185] dark:text-white min-[640px]:w-[36px]"
                ...
                <!-- Ikon Close -->
                <svg id="icon-close"
                    class="hidden w-[36px] text-[#A72185] transition-transform duration-300 ease-in-out group-hover:text-[#A72185] min-[640px]:w-[60px]"
...
<div class="dark:bg-opacity-55 hidden w-full bg-[#F9F9FC] px-5 py-8 dark:bg-zinc-800" id="navbar-hamburger">
    ...
    <form method="GET" action="{{ route('front.search') }}"
        class="relative mb-5 flex h-12 items-center rounded-full border border-[#E8EBF4] transition-all duration-100 focus-within:ring-2 focus-within:ring-[#A72185] dark:border-zinc-600 max-sm:h-10">
    ...
    <!-- Tombol Post Ads -->
    <ul
        class="items-centerrounded-full mt-4 flex flex-col font-medium transition-all duration-100 dark:border-[#A72185]">
        <li>
            <a href="mailto:ciamistimes@gmail.com?subject=Pemesanan%20Pemasangan%20Iklan%20di%20Ciamis%20Times&body=Kepada%20Tim%20Ciamis%20Times%2C%0A%0ASaya%20ingin%20melakukan%20pemesanan%20untuk%20pemasangan%20iklan%20di%20situs%20web%20Ciamis%20Times.%20Berikut%20adalah%20informasi%20terkait%20pemesanan%20iklan%3A%0A%0A-%20Nama%20Perusahaan%3A%20%5BNama%20Perusahaan%5D%0A-%20Jenis%20Iklan%3A%20%5BBanner%2C%20Square%5D%0A-%20Durasi%20Pemasangan%20Iklan%3A%20%5BBerapa%20Lama%20Iklan%20Akan%20Tayang%5D%0A-%20Anggaran%3A%20%5BAnggaran%20untuk%20Iklan%5D%0A-%20Kontak%20Person%3A%20%5BNama%20Kontak%20Person%5D%0A-%20Email%20Kontak%20Person%3A%20%5BEmail%20Kontak%20Person%5D%0A-%20Telepon%20Kontak%20Person%3A%20%5BNomor%20Telepon%20Kontak%20Person%5D%0A%0AMohon%20informasi%20lebih%20lanjut%20mengenai%20prosedur%20dan%20harga%20pemasangan%20iklan%20di%20Ciamis%20Times%2C%20serta%20syarat%20dan%20ketentuan%20yang%20berlaku.%0A%0ATerima%20kasih%20atas%20perhatian%20dan%20kerjasamanya.%20Saya%20menunggu%20balasan%20dari%20Tim%20Ciamis%20Times.%0A%0AHormat%20saya%2C%0A%5BNama%20Anda%5D%0A%5BPerusahaan%20Anda%20(jika%20ada)%5D"
                class="block rounded-full border-2 border-[#A72185] bg-[#A72185] text-center text-white hover:shadow-[0_10px_15px_0_#A7218580] dark:bg-[#19191c] dark:hover:bg-[#A72185]">
